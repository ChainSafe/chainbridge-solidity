...
export class ERC20SXHandler___depositRecordsResult {
  value0: Address;
  value1: i32;
  value2: i32;
  value3: Bytes;
...
export class ERC20SXHandler__getDepositRecordResultValue0Struct extends ethereum.Tuple {
...
export class ERC20SXHandler extends ethereum.SmartContract {
  static bind(address: Address): ERC20SXHandler {
    return new ERC20SXHandler("ERC20SXHandler", address);
  }
  ...
  _depositRecords(
    param0: i32,
    param1: BigInt
  ): ERC20SXHandler___depositRecordsResult {
    let result = super.call(
      "_depositRecords",
    ...
    return new ERC20SXHandler___depositRecordsResult(
      result[0].toAddress(),
      result[1].toI32(),
      result[2].toI32(),
      result[3].toBytes(),
  ...
  try__depositRecords(
    param0: i32,
    param1: BigInt
  ): ethereum.CallResult<ERC20SXHandler___depositRecordsResult> {
    let result = super.tryCall(
      "_depositRecords",
      "_depositRecords(uint8,uint64):(address,uint8,uint8,bytes32,bytes,address,uint256)",
      [
    ...
    return ethereum.CallResult.fromValue(
      new ERC20SXHandler___depositRecordsResult(
        value[0].toAddress(),
        value[1].toI32(),
        value[2].toI32(),
        value[3].toBytes(),
  ...
  try__sxVaultContract(): ethereum.CallResult<Address> {
    let result = super.tryCall(
      "_sxVaultContract",
      "_sxVaultContract():(address)",
      []
  ...
  getDepositRecord(
    depositNonce: BigInt,
    destId: i32
  ): ERC20SXHandler__getDepositRecordResultValue0Struct {
    let result = super.call(
      "getDepositRecord",
    ...
    return changetype<ERC20SXHandler__getDepositRecordResultValue0Struct>(
      result[0].toTuple()
    );
  }
  ...
  try_getDepositRecord(
    depositNonce: BigInt,
    destId: i32
  ): ethereum.CallResult<ERC20SXHandler__getDepositRecordResultValue0Struct> {
    let result = super.tryCall(
      "getDepositRecord",
      "getDepositRecord(uint64,uint8):((address,uint8,uint8,bytes32,bytes,address,uint256))",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      changetype<ERC20SXHandler__getDepositRecordResultValue0Struct>(
        value[0].toTuple()
      )
    );
  }
...
export class SetSxVaultContractCall extends ethereum.Call {
  get inputs(): SetSxVaultContractCall__Inputs {
    return new SetSxVaultContractCall__Inputs(this);
  }

  get outputs(): SetSxVaultContractCall__Outputs {
    return new SetSxVaultContractCall__Outputs(this);
  }
}

export class SetSxVaultContractCall__Inputs {
  _call: SetSxVaultContractCall;

  constructor(call: SetSxVaultContractCall) {
    this._call = call;
  }

  get sxVaultContract(): Address {
    return this._call.inputValues[0].value.toAddress();
  }
}

export class SetSxVaultContractCall__Outputs {
  _call: SetSxVaultContractCall;
