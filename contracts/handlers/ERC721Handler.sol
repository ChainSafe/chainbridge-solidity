...
contract ERC721Handler is IDepositExecute, HandlerHelpers, ERC721Safe {
    ...
    /**
        ...
        @return _tokenAddress Address used when {deposit} was executed.
        @return _destinationChainID ChainID deposited tokens are intended to end up on.
        @return _resourceID ResourceID used when {deposit} was executed.
        @return _lenDestinationRecipientAddress Used to parse recipient's address from {_destinationRecipientAddress}
        @return _destinationRecipientAddress Address tokens are intended to be deposited to on desitnation chain.
        @return _depositer Address that initially called {deposit} in the Bridge contract.
        @return _tokenID ID of ERC721.
        @return _metaData Optional ERC721 metadata.
    */
