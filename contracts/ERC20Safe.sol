...
contract ERC20Safe {
    ...
    function lockERC20(address tokenAddress, address owner, bytes memory recipient, uint amount) internal {
    ...
    function releaseERC20(address tokenAddress, address owner, bytes memory recipient, uint amount) internal {
        IERC20 erc20 = IERC20(tokenAddress);
        erc20.transferFrom(owner, recipient, amount);
    ...
    function mintERC20(address tokenAddress, bytes memory recipient, uint256 amount) internal {
