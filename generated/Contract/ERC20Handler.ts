...
export class ERC20Handler extends ethereum.SmartContract {
  ...
  try__bridgeAddress(): ethereum.CallResult<Address> {
    let result = super.tryCall('_bridgeAddress', '_bridgeAddress():(address)', [])
    if (result.reverted) {
  ...
  _burnList(param0: Address): boolean {
    let result = super.call('_burnList', '_burnList(address):(bool)', [ethereum.Value.fromAddress(param0)])

    return result[0].toBoolean()
  }

  try__burnList(param0: Address): ethereum.CallResult<boolean> {
    let result = super.tryCall('_burnList', '_burnList(address):(bool)', [ethereum.Value.fromAddress(param0)])
    if (result.reverted) {
      return new ethereum.CallResult()
    }
    let value = result.value
  ...
  _contractWhitelist(param0: Address): boolean {
    let result = super.call('_contractWhitelist', '_contractWhitelist(address):(bool)', [
  ...
  try__contractWhitelist(param0: Address): ethereum.CallResult<boolean> {
    let result = super.tryCall('_contractWhitelist', '_contractWhitelist(address):(bool)', [
      ethereum.Value.fromAddress(param0),
    ])
    if (result.reverted) {
      return new ethereum.CallResult()
  ...
  _depositRecords(param0: i32, param1: BigInt): ERC20Handler___depositRecordsResult {
    let result = super.call(
      '_depositRecords',
      '_depositRecords(uint8,uint64):(address,uint8,uint8,bytes32,bytes,address,uint256)',
      [ethereum.Value.fromUnsignedBigInt(BigInt.fromI32(param0)), ethereum.Value.fromUnsignedBigInt(param1)]
    )
  ...
  try__depositRecords(param0: i32, param1: BigInt): ethereum.CallResult<ERC20Handler___depositRecordsResult> {
  ...
  try__resourceIDToTokenContractAddress(param0: Bytes): ethereum.CallResult<Address> {
    let result = super.tryCall(
      '_resourceIDToTokenContractAddress',
      '_resourceIDToTokenContractAddress(bytes32):(address)',
      [ethereum.Value.fromFixedBytes(param0)]
  ...
  try__tokenContractAddressToResourceID(param0: Address): ethereum.CallResult<Bytes> {
    let result = super.tryCall(
      '_tokenContractAddressToResourceID',
      '_tokenContractAddressToResourceID(address):(bytes32)',
      [ethereum.Value.fromAddress(param0)]
  ...
  getDepositRecord(depositNonce: BigInt, destId: i32): ERC20Handler__getDepositRecordResultValue0Struct {
    let result = super.call(
      'getDepositRecord',
      'getDepositRecord(uint64,uint8):((address,uint8,uint8,bytes32,bytes,address,uint256))',
      [ethereum.Value.fromUnsignedBigInt(depositNonce), ethereum.Value.fromUnsignedBigInt(BigInt.fromI32(destId))]
    )

    return changetype<ERC20Handler__getDepositRecordResultValue0Struct>(result[0].toTuple())
  }
  ...
  try_getDepositRecord(
    ...
    let value = result.value
    return ethereum.CallResult.fromValue(
      changetype<ERC20Handler__getDepositRecordResultValue0Struct>(value[0].toTuple())
    )
  }
}
